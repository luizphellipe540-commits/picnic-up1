...
function App(): JSX.Element {
  ...
  return (
    <div className="min-h-screen bg-[#00825c]">
      ...
      <main className="bg-black min-h-screen flex flex-col items-center px-4 py-16 relative">
          ...
          <div className="text-center space-y-12">
            ...
            <div className="relative group mt-16">
              <div
                ...
                className="rounded-xl overflow-hidden shadow-[0_0_36px_12px_rgba(0,0,0,0.65)]"
              >
                <iframe
                  id="panda-1121db2e-d60b-4ec1-bb07-15520f837aa4"
                  src="https://player-vz-9e787b14-a69.tv.pandavideo.com.br/embed/?v=1121db2e-d60b-4ec1-bb07-15520f837aa4"
                ...
                <div className="relative bg-gradient-to-br from-[#ab0101] to-[#5b0202] border-4 border-red-800 rounded-2xl p-8 space-y-6 shadow-2xl">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 justify-center mt-8">
                      {/* Botão de Checkout */}
                      <a
                        href="https://www.ggcheckout.com/checkout/v2/HGKAg1Rjssvs30Z6jcwf"
                      ...
                      {/* Botão de Rejeição */}
                      <a
                        href="https://umpicnic-up1dw1.netlify.app"
